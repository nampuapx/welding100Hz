...
void HAL_I2C_Master_Transmit_IT_OS(I2C_HandleTypeDef *hi2c, uint16_t DevAddress, uint8_t *pData, uint16_t Size){
...
void HAL_I2C_Master_Transmit_Reg_IT_OS(I2C_HandleTypeDef *hi2c, uint16_t DevAddress, uint16_t reg, uint8_t *pData, uint16_t Size){

    uint32_t ulNotifiedValue;
    //HAL_I2C_Master_Transmit_IT(hi2c, DevAddress, pData, Size);
    //HAL_I2C_Master_Transmit_DMA(hi2c, DevAddress, pData, Size);
    HAL_I2C_Mem_Write_DMA(hi2c, DevAddress, reg, I2C_MEMADD_SIZE_8BIT, pData, Size);
...
void ssd1306_I2C_WriteMulti(I2C_TypeDef* I2Cx, uint8_t address, uint8_t reg, uint8_t* data, uint16_t count) {
    ...
    HAL_I2C_Master_Transmit_Reg_IT_OS(I2Cx, address, reg, data, count);
...
void ssd1306_I2C_Write(I2C_TypeDef* I2Cx, uint8_t address, uint8_t reg, uint8_t data) {
    ...
    HAL_I2C_Master_Transmit_Reg_IT_OS(I2Cx, address, reg, &data, 1);
//	ssd1306_I2C_Start(I2Cx, address, I2C_TRANSMITTER_MODE, I2C_ACK_DISABLE);
//	ssd1306_I2C_WriteData(I2Cx, reg);
